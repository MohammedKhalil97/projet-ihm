  ...
  <v-container fluid class="stations-lorraine">
    ...
    <v-card color="basil">
      ...
      <v-card-title class="mb-2">
        Gares de voyageurs France <span class="text--secondary ml-1">({{data.data.nhits}})</span>
        <v-spacer></v-spacer>
...
export default {
  ...
  data() {
    return {
      // Data Vars
      data: [],
      link: 'https://data.sncf.com/api/records/1.0/search/?dataset=referentiel-gares-voyageurs&q=&rows=500&sort=gare_alias_libelle_noncontraint',
      search: '',
      headers: [
        { text: 'code_gare', value: 'fields.code_gare' },
        { text: 'name', value: 'fields.gare_alias_libelle_noncontraint' },
        { text: 'rg_libelle', value: 'fields.rg_libelle' },
        { text: 'departement_numero', value: 'fields.departement_numero' },
